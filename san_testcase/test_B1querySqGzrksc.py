...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        print('end test')
        pass
class test_querySqGzrksc(MyTest):
    '''测试接口：1.	关注人员筛查列表数据'''

    def test_querySqGzrksc(self):
        '''测试用例1：1.	关注人员筛查列表数据'''
        ...
        self.url =(config.TestPlanUrl) +"/affairs//data/home/querySqGzrksc.do?pageNumber=1&pageSize=20&xq=&zjhm=&xm= "
