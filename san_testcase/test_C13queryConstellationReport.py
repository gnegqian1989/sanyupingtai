...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        print('end test')
        pass
class test_queryConstellationReport(MyTest):
    '''测试接口：1.	受损群体星座统计'''

    def test_queryConstellationReport(self):
        '''测试用例1：1.	受损群体星座统计'''
        ...
        self.url = (config.TestPlanUrl) + "/affairs/losscolony/losscolony/queryConstellationReport.do?"
        self.data = {
