...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        print('end test')
        pass
class test_querySqXghk(MyTest):
    '''测试接口：1.	下挂户口列表数据'''

    def test_querySqXghk(self):
        '''测试用例1：1.	下挂户口列表数据'''
        ...
        self.url =(config.TestPlanUrl) +"/affairs//data/home/querySqXghk.do?pageNumber=1&pageSize=20&xq=&zjhm=&xm="
